...
public class CPSCListActivity extends ListActivity {
	...
	private class GetRecalls extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			...
			URL = "http://api.usa.gov/recalls/search.json?&query=" + sbc
					+ "&organization=" + org + "&sort=date&per_page=50";
		...
		protected void onPostExecute(Void result) {
			 ...
			 * */
			ListAdapter adapter = new SimpleAdapter(CPSCListActivity.this,
