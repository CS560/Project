...
public class USDAListActivity extends ListActivity {
	...
	private class GetRecalls extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			 ...
			 * */
			ListAdapter adapter = new SimpleAdapter(USDAListActivity.this,
					recallRList, R.layout.recent_recall_view, new String[] {
							Title, Date, Description, Link }, new int[] {
							R.id.title, R.id.pubDate, R.id.description,
							R.id.link });
