...
public class SubCategoryMenu1 extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adp1 = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, organzation);
	...
	public void onItemSelected(AdapterView<?> arg1, View view, int arg2, long id) {
		...
		Toast.makeText(arg1.getContext(), "Selected: " + category,
				Toast.LENGTH_SHORT).show();
		mft = (EditText) findViewById(R.id.editTextM);
		if (arg1.equals(sp1)) {
			if (sp1.getSelectedItem().equals("FDA")
					|| sp1.getSelectedItem().equals("USDA")) {
				sp3.setEnabled(true);
				mft.setEnabled(false);
				...
				sp2.setAdapter(adp2);
				select();
				if (sp2.getSelectedItem().equals("mislabeled")
						|| sp2.getSelectedItem().equals("contaminaion"))
				...
				categories.add("Miriam");
				categories.add("Morel");
				categories.add("Mr.");
				categories.add("Mrs");
	...
	private void select() {
		...
		sp2.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				Toast.makeText(arg0.getContext(), "Selected: " + subcategory,
						Toast.LENGTH_SHORT).show();
		...
		cl.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (orgText.equals("FDA") || orgText.equals("USDA")) {
					...
					intent.putExtras(b2);
					intent.putExtras(b3);
					System.out.println("org: " + b + "cate:   " + b1
							+ "subcate: " + b2 + "Search: " + b3);
					System.out.println(orgText + "cate: " + cText + "subcate: "
							+ scText + "search: " + srhText);
					...
					System.out.println("-------" + b + "=======" + b1
							+ "+++++++" + b2 + "......." + b3);
					System.out.println(cText + "+++++++" + orgText + "////////"
							+ mfText + "?????????" + srhText);
					...
					System.out.println(cText + "+++++++" + scText + "////////"
							+ orgText);
